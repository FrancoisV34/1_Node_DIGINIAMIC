...
- (OPTION mais recommandé) utils/utils.js, un fichier utilitaire qui comporte des fonctions qui pourraient s'avérer transverses dans une optique de modularité, et d'évolution de l'application (par exemple, sendJson se retrouve dans tous les controllers, en cas d'ajout de nouvelles ressources à mon API)
